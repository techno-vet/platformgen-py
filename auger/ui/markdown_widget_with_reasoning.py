"""Enhanced markdown_widget with reasoning block support."""

import tkinter as tk
from tkinter import font as tkfont
import re
from .reasoning_animator import ReasoningAnimator


class MarkdownWidgetWithReasoning(tk.Text):
    """Dark-themed Markdown rendering with integrated reasoning callouts."""
    ...
    def __init__(self, parent, **kwargs):
        ...
        self._setup_tags()
        self.reasoning_animator = ReasoningAnimator(self)
    ...
    def _setup_tags(self):
        ...
        self.tag_config('reasoning_block',
                       foreground='#87ceeb',
                       background='#1f2937',
                       lmargin1=15,
                       lmargin2=15,
                       font=('Consolas', 9))
        self.tag_config('reasoning_title',
                       foreground='#9cdcfe',
                       background='#1f2937',
                       font=('Consolas', 10, 'bold'))
        self.tag_config('reasoning_thinking',
                       foreground='#fbbf24',
                       background='#1f2937',
    ...
    def append_reasoning(self, title: str, content: str):
        """Append a reasoning callout block.
        
        Args:
            title: Reasoning block title
            content: Reasoning text
        """
        self.reasoning_animator.insert_reasoning_callout(title, content)
